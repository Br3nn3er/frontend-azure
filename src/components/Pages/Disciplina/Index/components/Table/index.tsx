  ...
  return (
    <TableContainer>
      ...
      >
        <Thead>
          <Tr>
            <Th textAlign="center">Cód.</Th>
            <Th textAlign="center">Cód. Antigo</Th>
            <Th textAlign="center">Nome</Th>
            <Th textAlign="center">Curso</Th>
            <Th textAlign="center">CH Teórica</Th>
            <Th textAlign="center">CH Prática</Th>
            <Th textAlign="center">CH Total</Th>
        ...
        <Tbody>
          ...
          {disciplines.map(discipline => (
            <Tr key={`course-${discipline.codigo}`}>
              ...
              <Td>
                <Tooltip label={discipline.nome}>{discipline.nome}</Tooltip>
              </Td>
