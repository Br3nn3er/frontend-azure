...
${selectedQueue?.disciplina.codigo} - ${selectedQueue?.disciplina.nome} (${selectedQueue?.turma.turma}) - ${semester?.ano}/${semester?.semestre}
      ...
      <TableContainer>
        <ChackraTable
          className="queue-professor-with-class-table"
          ...
          <Tbody>
            ...
            {queues.map(queue => (
              <Tr key={`${keyPrefix}-queue-${queue.id}-${queue.turma.id}`}>
                ...
                >
                  <Tooltip
                    label={`${queue?.disciplina?.codigo} - ${queue.disciplina?.nome}`}
                  >
                    <Text>
                ...
                <Td>
                  <Tooltip label={queue.disciplina?.curso_disciplinas?.nome}>
                    {queue.disciplina?.curso_disciplinas?.nome}
                  </Tooltip>
                </Td>
